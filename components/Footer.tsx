...
export default function Footer() {
  return (
    <footer className="mt-6 border-t border-ink-300/20 bg-white">
      <div className="mx-auto max-w-shell px-4 py-8">
        ...
        {/* المواقع الشقيقة */}
        <div className="mt-6 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 border-t border-ink-300/20 pt-6 text-center text-xs text-ink-500">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-center text-[11px] text-ink-300">
          <span>من نحن</span>
        ...
        <div className="mt-4 text-center text-[11px] leading-relaxed text-ink-300">
        ...
        <div className="mt-8 flex flex-col items-center gap-3 border-t border-ink-300/20 pt-6 text-center text-[11px] text-ink-300 sm:flex-row sm:justify-between sm:text-start">
          <p>
