  ...
  return (
    ...
    >
      <div className="flex-1 rounded bg-white p-2.5 border border-ink-300/15">
        <div className="mb-1.5 flex items-baseline justify-between border-b border-ink-300/20 pb-2">
          <h2
            id="completed-heading"
            className="flex items-baseline gap-2 text-sm font-bold text-ink-900"
          >
            أعمال مكتملة مميزة
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <div className="sm:w-52 sm:shrink-0">
            <span className="ph-block mb-2 block aspect-[3/4] w-full rounded text-[11px]">
              الغلاف
            </span>
