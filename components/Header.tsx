...
export default function Header() {
  return (
    <header className="w-full bg-white">
      {/* الشريط العلوي */}
      <div className="border-b border-ink-300/20 bg-white text-[11px] text-ink-500">
        <div className="mx-auto flex max-w-shell items-center justify-between px-3 py-2">
      ...
      {/* إعلان الشريط العلوي */}
      <div className="mx-auto max-w-shell px-3 py-1.5">
      ...
      <div className="mx-auto flex max-w-shell flex-col gap-2 px-3 pb-2.5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a
          href="#"
          className="flex items-center justify-center gap-2 self-start rounded border border-ink-300/50 px-3 py-2 text-sm font-medium text-ink-700 hover:border-brand hover:text-brand sm:self-auto"
        >
