import type { RankingList } from "@/lib/placeholder-data";

export default function RankingSection({ list }: { list: RankingList }) {
  ...
  return (
    <div className="rounded-md bg-white p-3 shadow-sm">
      ...
      <a href="#" className="mb-2 flex gap-2 rounded p-1 hover:bg-surface">
